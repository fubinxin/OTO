...
Util = {
	...
	//post方式提交请求,根据request的请求修改  作者：白云飞  2014-03-20
	/* ==================================== start ========================================= */
	/**
	 * post方式请求方法
	 * @param url 请求地址
	...
	post:function(url,param,callBack){
		...
		$.ajax( url, {
			...
			success : function(data, textStatus, jqXHR) {
				...
				if ( outputModel.status == Util.consts.STATUS_SUCCESS || outputModel.status == undefined || outputModel.status == null) {
					// 回调成功处理方法

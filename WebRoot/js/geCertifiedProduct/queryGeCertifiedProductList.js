...
layui.addGeCertifiedProductData = function () {
    ...
    layer.open({
        ...
        closeBtn: 1,
        area: ['330px', '370px'],
        content: addr + '/view/geCertifiedProduct/addGeCertifiedProduct.html'
    });
...
layui.use('table', function () {
    ...
    table.render({
        ...
        url: addr + "/geCertifiedProduct/queryGeCertifiedProduct",
    ...
    table.on('tool(tableFilter)', function (obj) {
        ...
        if (obj.event === 'detail') {
            ...
            layer.open({
                ...
                closeBtn: 1,
                area: ['330px', '370px'],
                content: addr + '/view/geCertifiedProduct/editGeCertifiedProduct.html?id=' +
                    data.id
            });
        }
    });
    ...
    function del(id) {
        var result = false;
        $.ajax({
            url: addr + '/geCertifiedProduct/deleteGeCertifiedProduct?id=' + id,
            type: "post",
            async: false,
            xhrFields: {

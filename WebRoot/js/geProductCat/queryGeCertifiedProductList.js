...
layui.addGeCertifiedProductData = function () {
    ...
    layer.open({
        ...
        closeBtn: 1,
        area: ['auto', '30%'],
        content: addr + '/view/geProductCat/addGeCertifiedProduct.html'
    });
...
layui.use('table', function () {
    ...
    table.render({
        ...
        url: addr + "/geCategory/query_category?categoryid=1",
    ...
    table.on('tool(tableFilter)', function (obj) {
        ...
        if (obj.event === 'detail') {
            ...
            layer.open({
                ...
                closeBtn: 1,
                area: ['auto', '30%'],
                content: addr + '/view/geProductCat/editGeCertifiedProduct.html?id=' +
                    data.id
            });
        }
    });
